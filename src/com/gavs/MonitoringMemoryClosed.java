...
public class MonitoringMemoryClosed {
	...
	public static void uploadSolrData() throws IOException {
		...
		String fileName = GavelConstant.FILE_PATH+"MonitoringMemoryClosed.xlsx";
		...
		System.out.println("Closed MonitoringMemory loaded successfully");
	}
