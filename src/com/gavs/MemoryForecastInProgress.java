 ...
 *
 */
public class MemoryForecastInProgress {
	...
	public static void uploadSolrData() throws IOException {
		...
		String fileName = GavelConstant.FILE_PATH+"MemoryforecastInProgress.xlsx";
		...
		System.out.println("InProgress MemoryForecast loaded successfully");
	}
