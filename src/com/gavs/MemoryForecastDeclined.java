 ...
 *
 */
public class MemoryForecastDeclined {
	...
	public static void uploadSolrData() throws IOException {
		...
		String fileName = GavelConstant.FILE_PATH+"MemoryforecastDeclined.xlsx";
		...
		System.out.println(" Declined MemoryForecast loaded successfully");
	}
