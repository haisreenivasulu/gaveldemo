 ...
 *
 */
public class MonitoringMemoryDeclined {
	...
	public static void uploadSolrData() throws IOException {
		...
		String fileName = GavelConstant.FILE_PATH+"MonitoringMemoryDeclined.xlsx";
		...
		System.out.println(" Declined MonitoringMemory loaded successfully");
	}
