 ...
 *
 */
public class MonitoringInProgressCPU {
	...
	public static void uploadSolrData() throws IOException {
		...
		String fileName = GavelConstant.FILE_PATH+"MonitoringCPUInProgress.xlsx";
		...
		System.out.println("InProgress MonitoringCPU loaded successfully");
	}
